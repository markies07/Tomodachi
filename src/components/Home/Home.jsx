    ...
    return (
        <div className='pt-19 pb-10'>
            ...
            <div className='relative'>
                <img src={banner} alt="" />
                <p style={{textShadow: "1px 1px 2px rgba(0, 0, 0, 0.3)"}} className='absolute -bottom-2 w-full sm:bottom-2 md:bottom-0 lg:bottom-5 xl:bottom-7 lg:text-2xl text-xl text-[#FF0000] font-extrabold flex justify-center'>Cavite Branch</p>
            </div>
