        ...
        <div className='pt-24 pb-10 px-5'>
            ...
            <div className='pt-10 flex flex-col max-w-[35rem] md:max-w-[40rem] mx-auto md:flex-row gap-3'>
                <div className='flex flex-col gap-3'>
                    {/* CONTACT */}
                    <div  className='p-5' style={{boxShadow: '1px 1px 15px 2px rgba(0, 0, 0, 0.13)'}}>
                ...
                {/* LOCATION */}
                <div className='p-5 md:px-6' style={{boxShadow: '1px 1px 15px 2px rgba(0, 0, 0, 0.13)'}}>
                    <div className='flex gap-4 items-center'>
            ...
            <div className=' mt-3 w-full md:max-w-[40rem] max-w-[35rem] mx-auto h-52' style={{boxShadow: '1px 1px 15px 2px rgba(0, 0, 0, 0.13)'}}>
